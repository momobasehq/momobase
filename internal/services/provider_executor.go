...
func (e *RuntimeProviderExecutor) Collect(ctx context.Context, id string, req providers.PaymentRequest) (*providers.ProviderPaymentResponse, error) {
	p, err := e.ready(id, domain.ServiceCollection)
	if err != nil {
		return nil, err
	}
...
func (e *RuntimeProviderExecutor) Disburse(ctx context.Context, id string, req providers.PaymentRequest) (*providers.ProviderPaymentResponse, error) {
	p, err := e.ready(id, domain.ServiceDisbursement)
	if err != nil {
		return nil, err
	}
...
func (e *RuntimeProviderExecutor) QueryTransaction(ctx context.Context, id, ref string) (*providers.ProviderTransactionStatus, error) {
	p, err := e.ready(id, "")
	if err != nil {
		return nil, err
	}
	return execute(ctx, e, p, "status", func(c context.Context) (*providers.ProviderTransactionStatus, error) {
		return p.Adapter.QueryTransaction(c, ref)
	})
}
func (e *RuntimeProviderExecutor) QueryBalance(ctx context.Context, id string) (*providers.ProviderBalance, error) {
	p, err := e.ready(id, "")
	if err != nil {
		return nil, err
	}
	return execute(ctx, e, p, "balance", func(c context.Context) (*providers.ProviderBalance, error) { return p.Adapter.QueryBalance(c) })
}
...
func (e *RuntimeProviderExecutor) ready(id, service string) (*RuntimeProvider, error) {
