  ...
  return (
    <div className="flex flex-col gap-2">
      <div>
        ...
        <p className="text-muted-foreground">Flat values use minor units; percentages use basis points (1,000 = 10%).</p>
      </div>
      <RuleField
        id={`${id}-collection`}
        label="Collections"
      ...
      <RuleField
        ...
        onChange={(disbursement) => onChange({ ...value, disbursement })}
      />
    </div>
  )
}
